...
export declare function computeInitials(subject: AvatarSubject): string;
 ...
 */
export declare function avatarFromJwt(claims: AvatarJwtClaims): {
    avatarUrl: string | null;
 ...
 * engage, and leave.
 */
export declare function initialsBackgroundColor(seed: string): string;
